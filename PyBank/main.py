...
file.write("Total revenue: $"+ str(revenue)+'\n')
file.write("Average change in revenue: $"+str(previous_revenue)+'\n')
file.write("Highest increase in revenue: "+str(high)+" on "+high_date+'\n')
file.write("Highest decrease in revenue: "+str(low)+" on "+low_date+'\n')
